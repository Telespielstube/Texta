...
class Parser():
    ...
    def parse_header(self, protocol_header, neighbor_node):
        protocol_field = protocol_header.split('|')
        if protocol_field[2] == '1':
        ...
        if protocol_field[2] == '3':           
            # requested_node = protocol_field[4]
            self.writer.route_request(RouteRequest(protocol_field[1], protocol_field[2], protocol_field[3], protocol_field[4], protocol_field[5]), neighbor_node)
        if protocol_field[2] == '4':
            # end_node = protocol_field[4], next_node = protocol_field[5]
            self.writer.route_reply(RouteReply(protocol_field[1], protocol_field[2], protocol_field[3], protocol_field[4], protocol_field[5], protocol_field[6]), neighbor_node)
        if protocol_field[2] == '5':
            #broken_node = protocol_field[3]
            self.writer.route_error(RouteError(protocol_field[1], protocol_field[2], protocol_field[3], protocol_field[4]))
